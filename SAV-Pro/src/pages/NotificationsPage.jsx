...
export function NotificationsPage({ notify, clientMode = false }) {
  ...
  return (
    <section className={clientMode ? 'page-shell' : 'page-shell'}>
      <div className="page-title-row"><div><h1>Notifications</h1><p>Review workflow alerts and customer updates.</p></div><Button icon={CheckCircle} onClick={markAll}>Mark all as read</Button></div>
