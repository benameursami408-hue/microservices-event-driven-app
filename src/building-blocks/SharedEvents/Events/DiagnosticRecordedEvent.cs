...
public record DiagnosticRecordedEvent : IIntegrationEvent
{
    public Guid EventId { get; init; } = Guid.NewGuid();
    public string EventType { get; init; } = nameof(DiagnosticRecordedEvent);
    ...
    public bool RequiresParts { get; init; }
