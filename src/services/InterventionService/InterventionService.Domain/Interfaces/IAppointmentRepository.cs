...
public interface IAppointmentRepository
{
    ...
    Task<List<Appointment>> QueryAsync(long? reclamationId = null, long? technicianId = null, DateTime? from = null, DateTime? to = null, CancellationToken cancellationToken = default);
